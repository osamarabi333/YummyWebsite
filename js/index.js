...
async function displayAreas() {
  ...
  async function displayMealsByArea(area) {
    try {
      ...
      console.error(`Error fetching or displaying meals for area ${area}:`, error);
    }
  }
...
async function displayIngredients() {
  ...
  async function displayMealsByIngredient(ingredient) {
    try {
      ...
      console.error(`Error fetching or displaying meals for ingredient ${ingredient}:`, error);
    }
  }
 ...
 // Function to display other sections contact form and hide contact form
  ...
  function validateForm() {
    ...
    const doPasswordsMatch = passwordsMatch(password.value.trim(), repassword.value.trim());
    ...
    const isValidForm = isNameValid && isEmailValid && isPhoneValid && isAgeValid && isPasswordValid && doPasswordsMatch;
...
document.getElementById('repasswordInput').addEventListener('input', validateForm);
